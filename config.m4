...
if test "$PHP_YAR" != "no"; then
  ...
  PHP_NEW_EXTENSION(yar, aes.c yar_encrypt.c yar.c yar_server.c yar_client.c yar_request.c yar_response.c yar_exception.c yar_packager.c yar_protocol.c packagers/php.c packagers/json.c packagers/msgpack.c yar_transport.c transports/curl.c transports/socket.c, $ext_shared)
